...
function startLearningPhase() {
    ...
    if ((groupInput === "1" || groupInput === "2" || groupInput === "3") && personalCodeInput) {
        ...
        alert("Please enter a valid group number (1, 2, or 3) and your personal code.");
    }
}
...
function playAudioSequence() {
    const audioQueue = [
        { category: "Cardiovascular", priority: "High", src: getAudio("Cardiovascular", "High") },
        { category: "Cardiovascular", priority: "Medium", src: getAudio("Cardiovascular", "Medium") },
        { category: "Ventilation", priority: "High", src: getAudio("Ventilation", "High") },
        { category: "Ventilation", priority: "Medium", src: getAudio("Ventilation", "Medium") },
        { category: "DrugAdministration", priority: "High", src: getAudio("DrugAdministration", "High") },
        { category: "DrugAdministration", priority: "Medium", src: getAudio("DrugAdministration", "Medium") }
    ];
...
function playSequence(queue, repetitions, callback) {
    ...
    function playNext() {
        ...
        function playAudio() {
            ...
            document.getElementById("design").textContent = currentDesign === "icons" ? "Icons" : "Melodic";
...
document.getElementById("finish-test").addEventListener("click", () => {
    exportToCSV();  
    document.getElementById("test-phase").innerHTML = "<h2>Test Complete</h2><p>Thank you for participating!</p><p>You can close your browser now</p>";
});
